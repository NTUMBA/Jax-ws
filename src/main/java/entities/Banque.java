...
public class Banque {
	...
	public static void main(String[] args) throws Exception {
		...
		context.generateSchema(new SchemaOutputResolver() {// Le but est de
															// prendre le
															// modele( est le
															// transformer en
															// fichier xml
			...
			public Result createOutput(String namespaceUrl, String suggestedFileName) throws IOException {
				File f = new File("compte.xsd"); // permet de cerifier la
													// conformite car un xsd
													// peut contenir des regles
	...
	public static void marshal() throws Exception {
		...
		Compte cp = new Compte("CCP",2L, 5000F, new Date());
